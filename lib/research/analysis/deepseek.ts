      ...
      body: JSON.stringify({
        ...
        messages: [
          ...
          },
          {
            role: "user",
            content:
              `请综合以下所有广告/推广来源，包含官网推广页、Google 广告、Meta 广告等可用来源，生成适合竞品报告展示的广告推广分析。所有字段必须使用简体中文。不得编造素材中没有的事实；不确定时写“暂未判断”。严格使用此 JSON 结构，不要 Markdown：{"sourceCoverage":"","targetAudience":"","promotionDirection":"","useCases":"","sellingPoints":"","channels":["渠道名"],"targetAudiences":["人群"],"coreSellingPoints":["卖点"],"overview":[{"title":"覆盖来源|面向人群|推广方向|使用场景|核心卖点","summary":"80字以内","details":["短标签"]}],"communicationSignals":[{"title":"传播信息标题","summary":"80字以内","tags":["短标签"]}],"audienceScenarios":[{"segment":"目标人群","coreAppeal":"核心诉求，60字以内","scenarios":["高频场景"],"channels":["触达渠道"]}],"strategySummary":[{"title":"策略标题","points":["策略要点，60字以内"]}]}。overview 输出 5 项；communicationSignals 输出 3 项；audienceScenarios 输出 2-4 项；strategySummary 输出 3 项。\n\n${promotionText}`
          }
        ]
      }),
      signal: AbortSignal.timeout(30_000)
